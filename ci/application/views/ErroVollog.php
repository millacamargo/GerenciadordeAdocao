			...
			<!-- Inicio do conteudo de erro -->
				...
				<div class="container">
					<div class="row d-flex justify-content-center">
								<h1 style="text-align:center;"class="mb-20">Erro! Não foi possível completar sua requisição. Todos os campos precisam estar registrados</h1>
						</div>
						<div style="margin-left: 400px;margin-top:50px;">
					 <button type="button" onclick="window.location.href='https://gerenciadordeadocao-lfvasconcellos.c9users.io/ci/index.php/inicio/voluntariolog';" class="primary-btn">Voltar a Registro de Voluntário</button>
                    </div>
                </div>
