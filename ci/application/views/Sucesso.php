			...
			<section class="Volunteer-form-area section-gap">
				<div class="container">
					<div class="row d-flex justify-content-center">
					 ...
					 <button type="button" onclick="window.location.href='https://gerenciadordeadocao-camilacamargo98.c9users.io/ci/index.php/Animal_Results/showResults';" class="primary-btn">Ir para a Busca</button>
                    </div>
                </div>
                </div>
			</section>
