	...
	<head>
		...
		<body>
			...
			<!-- Inicio da area de depoimento -->
			<section class="testomial-area section-gap" id="testimonail">
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-60 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Depoimentos dos nossos guardiões</h1>
								<p>Quem está extremamente apaixonado por um sistema ecologicamente correto.</p>
							</div>
						</div>
					</div>						
					<div class="row">
						<div class="active-testimonial-carusel">
							<div class="single-testimonial item">
								<img class="mx-auto" src="<?= base_url();?>assets/img/t1.png" alt="">
								<p class="desc">
							...
							<div class="single-testimonial item">
								<img class="mx-auto" src="<?= base_url();?>assets/img/t2.png" alt="">
								<p class="desc">
									Accessories Here you can find the best computer accessory for your laptop, monitor, printer, scanner, speaker, projector, hardware and more. laptop accessory
								</p>
								<h4>Mark Alviro Wiens</h4>
							...
							<div class="single-testimonial item">
								<img class="mx-auto" src="<?= base_url();?>assets/img/t3.png" alt="">
								<p class="desc">
									Accessories Here you can find the best computer accessory for your laptop, monitor, printer, scanner, speaker, projector, hardware and more. laptop accessory
								</p>
								<h4>Mark Alviro Wiens</h4>
